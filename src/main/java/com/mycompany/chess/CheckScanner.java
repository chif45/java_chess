...
public class CheckScanner {
    ...
    private boolean checkKnight(piece p, piece k, int col, int row){
        return p != null && !board.sameTeam(p,k)&& p.name.equals("Knight") && !(p.coloumn == col && p.row == row);
    }
    ...
    private boolean checkPawn(piece p, piece k, int col, int row){
        return p!= null && !board.sameTeam(p,k) && p.name.equals("Pawn") && !(p.coloumn == col && p.row == row);
    }
